...
const EventPage = () => {
  ...
  const submitHandler = (e) => {
    ...
    const createEvent = async () => {
      try {
        ...
        if (data.success) {
          toast.success("Event Created Succeefully");
        }
      } catch (error) {
  ...
  return (
    <div className="grid lg:grid-cols-12  w-full mx-auto max-w-screen-lg mt-5">
      <div className="text-center col-start-1  col-end-3 text-white">
      ...
      <div className="text-center  col-start-4 col-end-12  text-white">
